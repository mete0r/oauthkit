...
const Maint = {
  ...
  refresh: function() {
    this.agent.refresh_token(this.require_token()).then(function(auth_token) {
...
exports.main = function() {
  ...
  const oauthman_dir = file.join(system.pathFor('Home'), '.oauthman', 'google');
  file.mkpath(oauthman_dir);
  ...
  for (let name in clients) {
    ...
    let token_store = {
      ...
      path: file.join(oauthman_dir, name + '.json')
    };
