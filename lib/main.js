...
const Client = {
  ...
  request_code: function(object) {
    ...
    return this.request_code_impl(uri);
  },
...
const Agent = {
  ...
  request_code_impl: function(uri) {

    console.log('request uri: ' + uri);

    const state = get_state_from_url(uri) || '';

    if (this.sessions[state] !== undefined) {
      throw {
        __proto__: Error.prototype,
        message: 'on-going session' + (state ? ' for ' + state : '') + ' exists'
      };
    }
